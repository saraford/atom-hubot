...
export default class HubotView {
  ...
  constructor(serializedState) {
    ...
    var file_location = document.createElement('div');
    file_location.id = "scripts-link";
    file_location.innerHTML = "file not found";
    script_section.appendChild(file_location);
